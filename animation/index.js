...
';
					...
					{
						var shader = shaders.m_lambert82;
						var vertexShader = engine.createVertexShader(vsm_lambert82, "mesh, shader 'lambert82'");
						var pixelShader = engine.createPixelShader(psm_lambert82, "mesh, shader 'lambert82'");
					...
					{
						var shader = shaders.m_lambert70;
						var vertexShader = engine.createVertexShader(vsm_lambert70, "mesh, shader 'lambert70'");
						var pixelShader = engine.createPixelShader(psm_lambert70, "mesh, shader 'lambert70'");
						var program = shader.program = gl.createProgram();
						gl.attachShader(program, vertexShader);
						gl.attachShader(program, pixelShader);
						gl.bindAttribLocation(program, 1, '_1');
					...
					{
						var shader = shaders.m_lambert59;
						var vertexShader = engine.createVertexShader(vsm_lambert59, "mesh, shader 'lambert59'");
						var pixelShader = engine.createPixelShader(psm_lambert59, "mesh, shader 'lambert59'");
						var program = shader.program = gl.createProgram();
						gl.attachShader(program, vertexShader);
						gl.attachShader(program, pixelShader);
						gl.bindAttribLocation(program, 1, '_1');
					...
					{
						var shader = shaders.m_lambert84;
						var vertexShader = engine.createVertexShader(vsm_lambert84, "mesh, shader 'lambert84'");
						var pixelShader = engine.createPixelShader(psm_lambert84, "mesh, shader 'lambert84'");
						var program = shader.program = gl.createProgram();
						gl.attachShader(program, vertexShader);
						gl.attachShader(program, pixelShader);
						gl.bindAttribLocation(program, 1, '_1');
					...
					{
						var shader = shaders.m_lambert68;
						var vertexShader = engine.createVertexShader(vsm_lambert68, "mesh, shader 'lambert68'");
						var pixelShader = engine.createPixelShader(psm_lambert68, "mesh, shader 'lambert68'");
						var program = shader.program = gl.createProgram();
						gl.attachShader(program, vertexShader);
						gl.attachShader(program, pixelShader);
						gl.bindAttribLocation(program, 1, '_1');
				...
				render: {
					m_lambert82_5: function(renderJob)
					{
						...
						var shader = global.shaders.m_lambert82;
					...
					m_lambert70_5: function(renderJob)
					{
						var instance = renderJob.instance;
						var global = instance.global;
						var shader = global.shaders.m_lambert70;
					...
					m_lambert59_5: function(renderJob)
					{
						var instance = renderJob.instance;
						var global = instance.global;
						var shader = global.shaders.m_lambert59;
					...
					m_lambert84_5: function(renderJob)
					{
						var instance = renderJob.instance;
						var global = instance.global;
						var shader = global.shaders.m_lambert84;
					...
					m_lambert68_5: function(renderJob)
					{
						var instance = renderJob.instance;
						var global = instance.global;
						var shader = global.shaders.m_lambert68;
				...
				draw: {
					...
					g: function(instance, shader)
					{
						...
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 588);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 576);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 3444);
					},
					h: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 3312);
					},
					i: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 1408);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4236);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4224);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 4284);
					},
					j: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 3864);
					},
					k: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 33690);
					},
					l: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset0);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 4812);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 4800);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 4416);
					},
					m: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset0);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 7212);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 7200);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 4968);
					},
					n: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 3008);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 9036);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 9024);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 5388);
					},
					o: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset0);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 17388);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 17376);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 7308);
					},
					p: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 54882);
					},
					q: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 3200);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 9612);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 9600);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 5520);
					},
					r: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 6960);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 20892);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 20880);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 8088);
					},
					s: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 19356);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 19344);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 162, gl.UNSIGNED_SHORT, 7764);
					},
					t: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 4000);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 12012);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 12000);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 6072);
					},
					u: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset0);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 12588);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 12576);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 6204);
					},
					v: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 4800);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 14412);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 14400);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 6624);
					},
					w: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 5600);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 16812);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 16800);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 7176);
					},
					x: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 6400);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 19212);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 19200);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 18, gl.UNSIGNED_SHORT, 7728);
					},
					y: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 5652);
					},
					z: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset0);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 14988);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 14976);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 6756);
					},
					A: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset0);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 35532);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 35520);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 11814);
					},
					B: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 7072);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 21228);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 21216);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 282, gl.UNSIGNED_SHORT, 8160);
					},
					C: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 10144);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 30444);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 30432);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 18, gl.UNSIGNED_SHORT, 10698);
					},
					D: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 10224);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 30684);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 30672);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 36, gl.UNSIGNED_SHORT, 10734);
					},
					E: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset1);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 31020);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 31008);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 162, gl.UNSIGNED_SHORT, 10806);
					},
					F: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 7104);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 21324);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 21312);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 48, gl.UNSIGNED_SHORT, 8724);
					},
					G: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 21216);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 939, gl.UNSIGNED_SHORT, 8820);
					},
					H: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 32556);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 32544);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 11130);
					},
					I: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 11648);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 34956);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 34944);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 11682);
					},
					J: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 11456);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 34380);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 34368);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 11550);
					},
					K: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 12234);
					},
					L: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 12786);
					},
					M: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 13338);
					},
					N: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 13890);
					},
					O: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 14442);
					},
					P: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 14994);
					},
					Q: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 15546);
					},
					R: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 16098);
					},
					S: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 16650);
					},
					T: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 17202);
					},
					U: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 17754);
					},
					V: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 18306);
					},
					W: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 18858);
					},
					X: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 19410);
					},
					Y: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 19962);
					},
					Z: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 20514);
					},
					ab: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 21066);
					},
					bb: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 21618);
					},
					cb: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 22170);
					},
					db: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 22722);
					},
					eb: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 23274);
					},
					fb: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 23826);
					},
					gb: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset3);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 37356);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 37344);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 24378);
					},
					hb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 39756);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 39744);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 102, gl.UNSIGNED_SHORT, 24930);
					},
					ib: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 13680);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 41052);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 41040);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25230);
					},
					jb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 13056);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 39180);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 39168);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 24798);
					},
					kb: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset3);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 41196);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 41184);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 25242);
					},
					lb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 14336);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 43020);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 43008);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 25662);
					},
					mb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 20200);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 60612);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 60600);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 126, gl.UNSIGNED_SHORT, 32532);
					},
					nb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 20552);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 61668);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 61656);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 171, gl.UNSIGNED_SHORT, 32784);
					},
					ob: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 43596);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 43584);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 18, gl.UNSIGNED_SHORT, 25794);
					},
					pb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 2208);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 6636);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 6624);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 4836);
					},
					qb: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset3);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 63804);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 63792);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 210, gl.UNSIGNED_SHORT, 33270);
					},
					rb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 63132);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 63120);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 72, gl.UNSIGNED_SHORT, 33126);
					},
					sb: function(instance, shader)
					{
						...
						gl.uniform4fv(shader.s_o, global.scaleOffset4);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 43788);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 43776);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 3351, gl.UNSIGNED_SHORT, 25830);
					},
					tb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 66204);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 66192);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 204, gl.UNSIGNED_SHORT, 33822);
					},
					ub: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 68028);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 68016);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 7776, gl.UNSIGNED_SHORT, 34230);
					},
					vb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40896);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25146);
					},
					wb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40752);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25158);
					},
					xb: function(instance, shader)
					{
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25170);
					},
					yb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40992);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25182);
					},
					zb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40608);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25194);
					},
					Ab: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40800);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25134);
					},
					Bb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40800);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25206);
					},
					Cb: function(instance, shader)
					{
						var global = instance.global;
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer0);
						gl.vertexAttribPointer(2, 2, gl.FLOAT, false, 8, 13608);
						gl.bindBuffer(gl.ARRAY_BUFFER, global.shaderInputBuffer1);
						gl.vertexAttribPointer(1, 3, gl.FLOAT, false, 24, 40836);
						gl.vertexAttribPointer(0, 3, gl.FLOAT, false, 24, 40824);
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 25218);
					},
					Db: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 49782);
					},
					Eb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 50334);
					},
					Fb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 50886);
					},
					Gb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 51438);
					},
					Hb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 51990);
					},
					Ib: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 52542);
					},
					Jb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 53094);
					},
					Kb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 53646);
					},
					Lb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 54198);
					},
					Mb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 66, gl.UNSIGNED_SHORT, 54750);
					},
					Nb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 55302);
					},
					Ob: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 55854);
					},
					Pb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 56406);
					},
					Qb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 56958);
					},
					Rb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 57510);
					},
					Sb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 58062);
					},
					Tb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 58614);
					},
					Ub: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 59166);
					},
					Vb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 59718);
					},
					Wb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 60270);
					},
					Xb: function(instance, shader)
					{
						var global = instance.global;
						...
						gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, global.indexBuffer0);
						gl.drawElements(gl.TRIANGLES, 276, gl.UNSIGNED_SHORT, 60822);
					}
				},
				...
				createInstance: function(global, renderer)
				{
					...
					instance.update = function()
					{
						...
						else
						{
							if (a < 5.20833)
							{
								b = (engine.eBT(buffers[0], buffers[1], 2, a * 12684.1 + -528.508) * 3.19584e-5 + -2.09439) * 0.5;
							}
							else
							{
								b = -1.04719;
						...
						ftransforms[1085] = h * -0.0129836 + j * 10.775 + 0.0129836;
						ftransforms[1086] = i * -0.0129836 + k * 10.775 + -10.775;
						...
						ouniforms[0] = ostate[64];
						ouniforms[1] = ostate[18];
						ouniforms[2] = ostate[1];
						ouniforms[3] = ostate[20];
						ouniforms[4] = ostate[35];
						ouniforms[5] = ostate[19];
						ouniforms[6] = ostate[50];
						ouniforms[7] = ostate[27];
						ouniforms[8] = ostate[57];
						ouniforms[9] = ostate[58];
						ouniforms[10] = ostate[67];
						ouniforms[11] = ostate[40];
						ouniforms[12] = ostate[2];
						ouniforms[13] = ostate[12];
						ouniforms[14] = ostate[11];
						ouniforms[15] = ostate[69];
						ouniforms[16] = ostate[16];
						ouniforms[17] = ostate[21];
						ouniforms[18] = ostate[47];
						ouniforms[19] = ostate[43];
						ouniforms[20] = ostate[8];
						ouniforms[21] = ostate[23];
						ouniforms[22] = ostate[34];
						ouniforms[23] = ostate[6];
						ouniforms[24] = ostate[46];
						ouniforms[25] = ostate[44];
						ouniforms[26] = ostate[10];
						ouniforms[27] = ostate[3];
						ouniforms[28] = ostate[53];
						ouniforms[29] = ostate[42];
						ouniforms[30] = ostate[33];
						ouniforms[31] = ostate[4];
						ouniforms[32] = ostate[15];
						ouniforms[33] = ostate[52];
						ouniforms[34] = ostate[65];
						ouniforms[35] = ostate[66];
						ouniforms[36] = ostate[48];
						ouniforms[37] = ostate[38];
						ouniforms[38] = ostate[29];
						ouniforms[39] = ostate[49];
						ouniforms[40] = ostate[60];
						ouniforms[41] = ostate[59];
						ouniforms[42] = ostate[45];
						ouniforms[43] = ostate[9];
						ouniforms[44] = ostate[37];
						ouniforms[45] = ostate[31];
						ouniforms[46] = ostate[28];
						ouniforms[47] = ostate[32];
						ouniforms[48] = ostate[51];
						ouniforms[49] = ostate[5];
						ouniforms[50] = ostate[63];
						ouniforms[51] = ostate[13];
						ouniforms[52] = ostate[30];
						ouniforms[53] = ostate[61];
						ouniforms[54] = ostate[71];
						ouniforms[55] = ostate[36];
						ouniforms[56] = ostate[70];
						ouniforms[57] = ostate[68];
						ouniforms[58] = ostate[62];
						ouniforms[59] = ostate[22];
						ouniforms[60] = ostate[39];
						ouniforms[61] = ostate[24];
						ouniforms[62] = ostate[0];
						ouniforms[63] = ostate[55];
						ouniforms[64] = ostate[14];
						ouniforms[65] = ostate[41];
						ouniforms[66] = ostate[54];
						ouniforms[67] = ostate[7];
						ouniforms[68] = ostate[17];
						ouniforms[69] = ostate[26];
						ouniforms[70] = ostate[56];
						ouniforms[71] = ostate[25];
					};
